...
#SBATCH --error=/gpfs/chencao/ysbioinfor/project/proteohubProject/err_file/mk_summ1_%a.err
#SBATCH --out=/gpfs/chencao/ysbioinfor/project/proteohubProject/out_file/mk_summ1_%a.out
#SBATCH --mem=2000
...
PRO=/gpfs/chencao/ysbioinfor/Datasets/ukb/pheno/04_olink/protein_label1.txt
...
do
	...
	then
		...
		# for sex in all
		do
			cd /gpfs/chencao/ysbioinfor/project/proteohubProject/web_out/pqlt/${pro}/
