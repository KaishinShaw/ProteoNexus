...
#SBATCH --error=/gpfs/chencao/ysbioinfor/project/proteohubProject/err_file/mk_summ2_%a.err
#SBATCH --out=/gpfs/chencao/ysbioinfor/project/proteohubProject/out_file/mk_summ2_%a.out
#SBATCH --mem=2000
...
PRO=/gpfs/chencao/ysbioinfor/Datasets/ukb/pheno/04_olink/protein_label2.txt
